...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Fluxium Hospital</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Fluxium Hospital </a>
                ...
                <div class="col-md-8">
                    <select name="doctor" class="form-control" id="doctor" required="required">
                      ...
                      <?php display_docs(); ?>
                        ...
                        <script>
                document.getElementById('doctor').onchange = function updateFees() {
                    var selectedOption = this.options[this.selectedIndex];
                    var consultancyFees = selectedOption.getAttribute('data-value');
                    
                    document.getElementById('docFees').value = consultancyFees;
                };
            </script>
